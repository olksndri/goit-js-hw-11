...
//   scrollPoint = document.querySelectorAll('.gallery .photo-card');
//   scrollFoo();
// };
...
//   element: scrollPoint[ind.length - 10], // елемент, для якого слід відстежувати точку прокрутки
//   handler: function (direction) {
//     console.log('Досягнута точка прокрутки!');
//   },
//   offset: '50%', // зміщення відносно видимості елементу (50% в цьому випадку)
// });
